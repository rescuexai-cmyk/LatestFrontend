...
/// Visual tokens for “book for later” sheets (distinct from golden “ride now” chrome).
abstract final class ScheduleLaterSheetAppearance {
  /// Gray-tone mandala (replace raster with authored gray artwork when exported).
  static const String grayMandalaAsset =
      'assets/images/schedule_ride_mandala_gray_bg.png';

  /// Figma: linear-gradient(182.84deg, #D5D5D5 -6.53%, #FFFFFF 25.37%)
  static const LinearGradient backgroundGradient = LinearGradient(
    begin: Alignment.topCenter,
    end: Alignment(0.0, 0.28),
    colors: [
      Color(0xFFD5D5D5),
      Color(0xFFFFFFFF),
    ],
  ...
  /// Modal top edge shadow: rgba(0,0,0,0.15), y -4, blur ~20
  static const List<BoxShadow> modalTopShadow = [
    BoxShadow(
  ...
  static final ColorFilter grayscaleMandalaFilter = ColorFilter.matrix([
  ...
  /// Tints colored mandala rasters toward gray until artwork is grayscale-only.
  static const double grayscaleMandalaOpacity = 0.48;
}
...
class ScheduleRidePickerSheet extends StatefulWidget {
  ...
  /// When set (e.g. editing an existing pickup time), offers a tap target to abandon scheduling.
  final VoidCallback? onSwitchToImmediateRide;
  final String switchToImmediateLabel;
  ...
  const ScheduleRidePickerSheet({
    ...
    this.onSwitchToImmediateRide,
    this.switchToImmediateLabel = 'Now',
  });

  /// Figma schedule header: gray mandala on white (see [ScheduleLaterSheetAppearance]).
  static const String sheetBgAsset =
    ...
    return ClipRRect(
      ...
      child: Container(
          decoration: BoxDecoration(
            ...
            gradient: ScheduleLaterSheetAppearance.backgroundGradient,
            boxShadow: ScheduleLaterSheetAppearance.modalTopShadow,
          ),
          child: Stack(
            ...
            children: [
                      ...
                      child: Stack(
                        ...
                        children: [
                          Positioned(
                            ...
                            right: 0,
                            child: Opacity(
                              opacity: ScheduleLaterSheetAppearance
                                  .grayscaleMandalaOpacity,
                              child: ColorFiltered(
                                colorFilter: ScheduleLaterSheetAppearance
                                    .grayscaleMandalaFilter,
                                child: Image.asset(
              ...
              Column(
                ...
                // Left inset matches "Pick up at" block (below) so back aligns with green-line guide.
                Padding(
                    ...
                    child: SafeArea(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.stretch,
                          children: [
                            if (widget.onSwitchToImmediateRide != null) ...[
                              TextButton(
                                onPressed: widget.onSwitchToImmediateRide,
                                child: Text(
                                  widget.switchToImmediateLabel,
